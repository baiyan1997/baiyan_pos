...
public class _Activity_2201_UI : ActivityUI
{
    private Text _tittleText;

    //货架1
    private Activity2201ItemUI[] _goodsList1;
    //货架2
    private Activity2201ItemUI[] _goodsList2;

    private Activity2201ItemUI[] _goodsList3;
    ...
    private ActInfo_2201 _actInfo;

    //货架1的购物车
    private List<Activity2201ItemUI> _selectList1 = new List<Activity2201ItemUI>();
    //购物车2
    private List<Activity2201ItemUI> _selectList2 = new List<Activity2201ItemUI>();
    private List<Activity2201ItemUI> _selectList3 = new List<Activity2201ItemUI>();
    //3种货架上分别能选购商品的种类数量
    private int[] _buyMaxCount = new int[] { 1, 2, 4 };

    private const int _aid = 2201;
    ...
    {
        _actInfo = (ActInfo_2201)ActivityManager.Instance.GetActivityInfo(_aid);
    ...
    private void InitRef()
    {
        ...
        _goodsList1 = new Activity2201ItemUI[]
        {
            new Activity2201ItemUI(commodityList1.Find("01")),
            new Activity2201ItemUI(commodityList1.Find("02")),
            new Activity2201ItemUI(commodityList1.Find("03")),
            new Activity2201ItemUI(commodityList1.Find("04")),
            new Activity2201ItemUI(commodityList1.Find("05")),
            new Activity2201ItemUI(commodityList1.Find("06")),
        };

        _goodsList2 = new Activity2201ItemUI[]
       {
            new Activity2201ItemUI(commodityList2.Find("01")),
            new Activity2201ItemUI(commodityList2.Find("02")),
            new Activity2201ItemUI(commodityList2.Find("03")),
            new Activity2201ItemUI(commodityList2.Find("04")),
            new Activity2201ItemUI(commodityList2.Find("05")),
            new Activity2201ItemUI(commodityList2.Find("06")),
       };

        _goodsList3 = new Activity2201ItemUI[]
       {
            new Activity2201ItemUI(commodityList3.Find("01")),
            new Activity2201ItemUI(commodityList3.Find("02")),
            new Activity2201ItemUI(commodityList3.Find("03")),
            new Activity2201ItemUI(commodityList3.Find("04")),
            new Activity2201ItemUI(commodityList3.Find("05")),
            new Activity2201ItemUI(commodityList3.Find("06")),
       };
    ...
    {
        base.UpdateUI(aid);
        if (aid == 2201 && gameObject.activeSelf)
            OnShow();
    }
    ...
    private void _OnShow()
    {
        ...
        {
            Activity2201ItemUI item = _goodsList2[i];
        ...
        {
            Activity2201ItemUI item = _goodsList3[i];
    ...
    private void OnClickItem(Activity2201ItemUI item, bool selected)
    {
        ...
        {
            Activity2201ItemUI item1 = _selectList1[0];
            _priceText.text = item1.Data.Pay._price;
        }
    }

    private void AddItem(Activity2201ItemUI item)
    {
        int maxcount = _buyMaxCount[item.Data.Type - 1];

        List<Activity2201ItemUI> list = null;
    ...
    private void RemoveItem(Activity2201ItemUI item)
    {
        List<Activity2201ItemUI> list = null;
...
public class Activity2201ItemUI
{
    private Image _icon;
    ...
    public Act2201ItemInfo Data { private set; get; }
    private ItemForShow _itemForShow;

    public Activity2201ItemUI(Transform trans)
    {
    ...
    public void Refresh(Act2201ItemInfo data, bool selected, Action<bool> callback)
    {
        Data = data;
        _callback = callback;
