...
public class ActInfo_2410: ActivityInfo
{
    ...
    {
        return Cfg.Activity2410.GetCfgActRankForType(1);
    }
}

public class P_ActInfo2410RankPoint
{
    public int rank_point;
    public int rank_gear;
}

public class P_ActInfo2410RankReward
{
...
public class P_ActInfo2410RankInfo
{
    public int uid;
    public string uname;
